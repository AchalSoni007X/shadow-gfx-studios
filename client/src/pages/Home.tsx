    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero" aria-labelledby="hero-title">
          ...
          <div className="hero-copy"><div className="hero-studio-name" aria-label="SHADOW GFX STUDIOS" style={{ display: "flex", alignItems: "baseline", gap: "12px", width: "fit-content", margin: "0 0 28px", paddingLeft: "12px", borderLeft: "4px solid var(--purple)", fontSize: "44px", fontWeight: 800, letterSpacing: "-0.055em", lineHeight: 1 }}><span>SHADOW GFX</span><em style={{ color: "var(--purple)", fontStyle: "normal", fontSize: "0.72em", fontWeight: 500, letterSpacing: "0.22em" }}>STUDIOS</em></div><p className="eyebrow" style={{ fontSize: "12px", letterSpacing: "0.13em", marginBottom: "21px" }}><span className="eyebrow-dot" /> Independent graphic design studio</p><h1 id="hero-title">Make them stop.<br /><em>Then make them look again.</em></h1><div className="hero-bottomline"><p>Visual identities, posters, edits, and social work for people building something worth noticing.</p><button className="circle-link" onClick={() => scrollTo("work")} aria-label="Explore selected work"><ArrowDownRight size={24} /></button></div></div>

...
const projects = [
  { id: "01", title: "Color / 01", category: "Color system & poster art", image: `${storage}image-1.png`, color: "orange" },
  { id: "02", title: "Identity / 01", category: "Brand identity system", image: `${storage}fallback-identity-board_1d87fd48.jpg`, color: "ink" },
  { id: "03", title: "Faces / 03", category: "Illustration study", image: `${storage}image-3.png`, color: "cyan" },
  { id: "04", title: "Motion / 04", category: "Vector illustration", image: `${storage}image-4.png`, color: "orange" },
  { id: "05", title: "Forms / 05", category: "Illustration series", image: `${storage}image-5.png`, color: "blue" },
  { id: "06", title: "Spectrum / 06", category: "Colorful vector illustration", image: `${storage}image-6.png`, color: "violet" },
];
    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero" aria-labelledby="hero-title">
          ...
          <div className="hero-copy" style={{ transform: "translateY(-42px)" }}><div className="hero-studio-name" aria-label="SHADOW GFX STUDIOS" style={{ display: "flex", alignItems: "baseline", gap: "12px", width: "fit-content", margin: "0 0 28px", paddingLeft: "12px", borderLeft: "4px solid var(--purple)", fontSize: "44px", fontWeight: 800, letterSpacing: "-0.055em", lineHeight: 1, fontFamily: "inherit" }}><span>SHADOW GFX</span><span style={{ color: "var(--purple)" }}>STUDIOS</span></div><p className="eyebrow" style={{ fontSize: "18px", fontWeight: 700, letterSpacing: "0.08em", lineHeight: 1.25, marginBottom: "21px" }}><span className="eyebrow-dot" /> Independent graphic design studio</p><h1 id="hero-title">Make them stop.<br /><em>Then make them look again.</em></h1><div className="hero-bottomline"><p>Visual identities, posters, edits, and social work for people building something worth noticing.</p><button className="circle-link" onClick={() => scrollTo("work")} aria-label="Explore selected work"><ArrowDownRight size={24} /></button></div></div>
